...
PROTOBUF_NAMESPACE_OPEN
template<> ::Per::Person* Arena::CreateMaybeMessage<::Per::Person>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Per {
...
class Person final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Per.Person) */ {
 public:
  ...
  public:
  void clear_addr();
  const ::Add::Address& addr() const;
  PROTOBUF_NODISCARD ::Add::Address* release_addr();
  ::Add::Address* mutable_addr();
  void set_allocated_addr(::Add::Address* addr);
  private:
  const ::Add::Address& _internal_addr() const;
  ::Add::Address* _internal_mutable_addr();
  public:
  void unsafe_arena_set_allocated_addr(
      ::Add::Address* addr);
  ::Add::Address* unsafe_arena_release_addr();
  ...
  // .Per.Color color = 6;
  void clear_color();
  ::Per::Color color() const;
  void set_color(::Per::Color value);
  private:
  ::Per::Color _internal_color() const;
  void _internal_set_color(::Per::Color value);
  public:

  // @@protoc_insertion_point(class_scope:Per.Person)
 private:
  class _Internal;
...
inline int32_t Person::id() const {
  // @@protoc_insertion_point(field_get:Per.Person.id)
  return _internal_id();
}
...
inline void Person::set_id(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:Per.Person.id)
}
...
inline std::string* Person::add_name() {
  ...
  // @@protoc_insertion_point(field_add_mutable:Per.Person.name)
  return _s;
}
...
inline const std::string& Person::name(int index) const {
  // @@protoc_insertion_point(field_get:Per.Person.name)
  return _internal_name(index);
}
inline std::string* Person::mutable_name(int index) {
  // @@protoc_insertion_point(field_mutable:Per.Person.name)
...
inline void Person::set_name(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:Per.Person.name)
}
...
inline void Person::set_name(int index, const char* value) {
  ...
  _impl_.name_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:Per.Person.name)
}
inline void Person::set_name(int index, const void* value, size_t size) {
  _impl_.name_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:Per.Person.name)
}
...
inline void Person::add_name(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:Per.Person.name)
}
...
inline void Person::add_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.name_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:Per.Person.name)
}
inline void Person::add_name(const void* value, size_t size) {
  _impl_.name_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:Per.Person.name)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Person::name() const {
  // @@protoc_insertion_point(field_list:Per.Person.name)
  return _impl_.name_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Person::mutable_name() {
  // @@protoc_insertion_point(field_mutable_list:Per.Person.name)
  return &_impl_.name_;
}
...
inline const std::string& Person::sex() const {
  // @@protoc_insertion_point(field_get:Per.Person.sex)
...
void Person::set_sex(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.sex_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Per.Person.sex)
}
inline std::string* Person::mutable_sex() {
  std::string* _s = _internal_mutable_sex();
  // @@protoc_insertion_point(field_mutable:Per.Person.sex)
  return _s;
}
...
inline std::string* Person::release_sex() {
  // @@protoc_insertion_point(field_release:Per.Person.sex)
...
inline void Person::set_allocated_sex(std::string* sex) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Per.Person.sex)
}
...
inline int32_t Person::age() const {
  // @@protoc_insertion_point(field_get:Per.Person.age)
...
inline void Person::set_age(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:Per.Person.age)
}
...
inline const ::Add::Address& Person::_internal_addr() const {
  const ::Add::Address* p = _impl_.addr_;
  return p != nullptr ? *p : reinterpret_cast<const ::Add::Address&>(
      ::Add::_Address_default_instance_);
}
inline const ::Add::Address& Person::addr() const {
  // @@protoc_insertion_point(field_get:Per.Person.addr)
...
inline void Person::unsafe_arena_set_allocated_addr(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Per.Person.addr)
}
inline ::Add::Address* Person::release_addr() {
  
  ::Add::Address* temp = _impl_.addr_;
...
inline ::Add::Address* Person::unsafe_arena_release_addr() {
  // @@protoc_insertion_point(field_release:Per.Person.addr)
  
  ::Add::Address* temp = _impl_.addr_;
  _impl_.addr_ = nullptr;
  return temp;
}
inline ::Add::Address* Person::_internal_mutable_addr() {
  
  if (_impl_.addr_ == nullptr) {
    auto* p = CreateMaybeMessage<::Add::Address>(GetArenaForAllocation());
    _impl_.addr_ = p;
  }
  return _impl_.addr_;
}
inline ::Add::Address* Person::mutable_addr() {
  ::Add::Address* _msg = _internal_mutable_addr();
  // @@protoc_insertion_point(field_mutable:Per.Person.addr)
  return _msg;
}
inline void Person::set_allocated_addr(::Add::Address* addr) {
  ...
  _impl_.addr_ = addr;
  // @@protoc_insertion_point(field_set_allocated:Per.Person.addr)
}
...
inline ::Per::Color Person::_internal_color() const {
  return static_cast< ::Per::Color >(_impl_.color_);
}
inline ::Per::Color Person::color() const {
  // @@protoc_insertion_point(field_get:Per.Person.color)
  return _internal_color();
}
inline void Person::_internal_set_color(::Per::Color value) {
  
  _impl_.color_ = value;
}
inline void Person::set_color(::Per::Color value) {
  _internal_set_color(value);
  // @@protoc_insertion_point(field_set:Per.Person.color)
}
...
template <> struct is_proto_enum< ::Per::Color> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Per::Color>() {
  return ::Per::Color_descriptor();
}
